...
//            registry.addSecurityOptions(policyPath, CARBON_HOME + "/repository/resources/security/wso2carbon.jks");
	...
	public String Put(server.activation.CoordinationContext coordinationContext, String data1, String data2, String data3) throws Exception {
        System.out.println("tesst  -------");

        CoordinationContext coordination=new CoordinationContext(coordinationContext.getIdentifier(),coordinationContext.getEndPointReference().getAddress(), coordinationContext.getCoordinationType(), coordinationContext.getEndPointReference().getPrivateInstance(), coordinationContext.getExpires());
